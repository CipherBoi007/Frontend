...
const AdminLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex">
            ...
            {/* Sidebar */}
            <div className={`
                fixed inset-y-0 left-0 z-50 w-64 bg-white text-slate-900 border-r border-slate-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex-shrink-0
